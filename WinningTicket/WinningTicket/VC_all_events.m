...
-(void) BTN_filter
{
    ...
    CGRect frameimg = CGRectMake(15,8, 30,25);
    UIButton *someButton = [[UIButton alloc] initWithFrame:frameimg];
    ...
    temp_IMG.contentMode = UIViewContentModeScaleToFill;
    ...
    someButton.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"temp_IMG"]];
...
-(BOOL)searchBarShouldBeginEditing:(UISearchBar *)searchBar
{
    ...
    searchBar1 = [[UISearchBar alloc]initWithFrame:CGRectMake(0,-5, self.navigationController.navigationBar.frame.size.width - 75,35)];
    ...
    UIGraphicsBeginImageContextWithOptions(temp_IMG.image.size, NO, newImage.scale);
    [[UIColor blackColor] set];
    [newImage drawInRect:CGRectMake(5, 15, 30, 30)];
    newImage = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
