...
- (void)setHasPageControl:(BOOL)hasPageControl {
    ...
    if (hasPageControl) {
        ...
        [pageControl setCurrentPageIndicatorTintColor:[UIColor colorWithRed:0.01 green:0.69 blue:0.87 alpha:1.0]];
...
- (void)setPageControlCurrentPageColor:(UIColor *)pageControlCurrentPageColor {
    _pageControlCurrentPageColor = [UIColor whiteColor];
    pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:0.01 green:0.69 blue:0.87 alpha:1.0];
}

//set the color of the others pages indicators
- (void)setPageControlOtherPagesColor:(UIColor *)pageControlOtherPagesColor {
    _pageControlOtherPagesColor = [UIColor whiteColor];
    pageControl.pageIndicatorTintColor = [UIColor colorWithRed:0.01 green:0.69 blue:0.87 alpha:1.0];
}
