...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cell.lbl_courseName respondsToSelector:@selector(setAttributedText:)]) {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
        {
            ...
            {
                [attributedText setAttributes:@{NSFontAttributeName:_Lbl_font_dist.font,NSForegroundColorAttributeName:[UIColor colorWithRed:0.09 green:0.64 blue:0.91 alpha:1.0]}
                                        range:RAN_miles];
            ...
            {
                [attributedText setAttributes:@{NSFontAttributeName:_Lbl_font_dist.font,NSForegroundColorAttributeName:[UIColor colorWithRed:0.00 green:0.67 blue:0.20 alpha:1.0]}
                                        range:RAN_miles];
            ...
            {
                [attributedText setAttributes:@{NSFontAttributeName:_Lbl_font_dist.font,NSForegroundColorAttributeName:[UIColor colorWithRed:0.74 green:0.74 blue:0.75 alpha:1.0]}
                                        range:RAN_miles];
